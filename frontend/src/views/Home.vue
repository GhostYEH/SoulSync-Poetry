...
<style scoped>
.cockpit-home { --jade-deep:#164b48; --jade:#2f8a7b; --jade-soft:#cfe8df; --ink:#213534; --muted:#6d817d; --line:rgba(51,103,94,.16); max-width:1280px; margin:0 auto; padding:42px 28px 96px; color:var(--ink); }
...
.footprint-layout{display:grid;grid-template-columns:.92fr 1.08fr;gap:18px}.footprint-summary,.ranking-card{min-height:300px;padding:28px;border:1px solid var(--line);border-radius:18px;background:rgba(255,255,255,.48)}.summary-top,.ranking-card-head{display:flex;justify-content:space-between;align-items:flex-start;gap:12px}.summary-top>span{color:var(--jade-deep);font:600 16px var(--font-ancient)}.text-action{padding:0;color:var(--jade);font:600 12px var(--font-sans)}.summary-number{display:flex;align-items:baseline;gap:12px;margin-top:42px}.summary-number strong{color:var(--jade-deep);font:600 74px/.85 var(--font-sans);letter-spacing:-.08em}.summary-number span{color:var(--muted);font:12px/1.55 var(--font-sans)}.week-dots{display:grid;grid-template-columns:repeat(7,1fr);gap:9px;margin-top:35px}.week-dots span{display:flex;flex-direction:column;align-items:center;gap:9px;color:#94a7a1;font:10px var(--font-sans)}.week-dots i{width:10px;height:10px;border:1px solid #b7c9c0;border-radius:50%}.week-dots .active i{border-color:var(--jade);background:var(--jade);box-shadow:0 0 0 4px rgba(47,138,123,.1)}.ranking-card-head .eyebrow{margin-bottom:7px;font-size:10px}.ranking-card-head strong{color:var(--jade-deep);font:600 20px var(--font-ancient)}.ranking-tabs{display:flex;gap:7px}.ranking-tabs button{padding:6px 8px;border:0;border-radius:6px;background:transparent;color:var(--muted);font-size:11px}.ranking-tabs button.active{background:var(--jade-soft);color:var(--jade-deep)}.ranking-rows{margin-top:22px}.ranking-row{display:grid;grid-template-columns:24px 30px 1fr auto;align-items:center;gap:9px;min-height:46px;border-top:1px solid rgba(76,132,119,.11);color:var(--muted);font:12px var(--font-sans)}.ranking-rank{color:#8aa69d;font-weight:600}.ranking-avatar{display:grid;place-items:center;width:26px;height:26px;border-radius:50%;background:var(--jade-soft);color:var(--jade-deep);font:12px var(--font-ancient)}.ranking-name{color:var(--ink)}.ranking-score{color:var(--jade-deep);font-weight:600}.ranking-score small{margin-left:3px;color:var(--muted);font-size:10px;font-weight:400}.loading-state,.error-state{padding:36px 20px;color:var(--muted);text-align:center;font:13px var(--font-sans)}.error-state{display:flex;justify-content:center;gap:14px}.compact-loading{padding:24px 0}.ai-home-section{margin:92px -28px 0;border-top:1px solid rgba(76,132,119,.12)}
